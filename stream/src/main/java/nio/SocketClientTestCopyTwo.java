 ...
 */
public class SocketClientTestCopyTwo {
    ...
    private void process(Selector selector,SelectionKey key) throws Exception{
        if(key.isConnectable()){
            ...
            ByteBuffer buffer =ByteBuffer.allocate(100).put("client by copy".getBytes());
            buffer.flip();
    ...
    public static void main(String[] args) throws Exception {
        SocketClientTestCopyTwo test = new SocketClientTestCopyTwo();
//        test.customClient();
//        test.blockClient();
